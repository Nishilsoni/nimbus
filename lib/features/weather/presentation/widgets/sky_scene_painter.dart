...
/// Paints the scene for one condition at a point in its animation [loop].
///
/// Shared by the animated `ConditionIllustration` and the static
/// `ConditionIcon` used in forecasts, so both speak one visual language.
class SkyScenePainter extends CustomPainter {
  SkyScenePainter({
  ...
  @override
  bool shouldRepaint(SkyScenePainter oldDelegate) =>
